...
namespace Stu.DAL
{
    public class DBHelper
    {
            ...
            //数据库连接字符串--记得改
            public static string connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\xy\source\repos\Stu_Info_Management_System.mdf;Integrated Security=True;Connect Timeout=30";
            //定义数据库连接对象
